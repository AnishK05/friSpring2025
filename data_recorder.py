    ...
    def record_sample(self):
        ...
        if self.recording and not rospy.is_shutdown():
            ...
            if self.store_observations:
                ...
                try:
                    plt.imsave(f"{self.filename}/demo_{self.demo_num}/sample_{self.sample_count}_color.png", color)
                    plt.imsave(f"{self.filename}/demo_{self.demo_num}/sample_{self.sample_count}_depth.png", depth)
